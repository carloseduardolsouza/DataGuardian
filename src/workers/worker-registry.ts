...
export type WorkerName = 'backup' | 'restore' | 'scheduler' | 'health' | 'cleanup' | 'db_sync' | 'restore_drill';

const WORKER_NAMES: WorkerName[] = ['backup', 'restore', 'scheduler', 'health', 'cleanup', 'db_sync', 'restore_drill'];
