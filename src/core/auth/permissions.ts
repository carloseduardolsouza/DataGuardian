export const PERMISSIONS = {
  ...
  RESTORE_DRILL_JOBS_READ: 'restore_drill_jobs.read',
  RESTORE_DRILL_JOBS_WRITE: 'restore_drill_jobs.write',
  RESTORE_DRILL_JOBS_RUN: 'restore_drill_jobs.run',
...
export const PERMISSION_SEEDS: PermissionSeed[] = [
  ...
  { key: PERMISSIONS.DB_SYNC_JOBS_READ, label: 'Ver jobs de sincronizacao', description: 'Listar e visualizar jobs de sincronizacao de banco' },
  { key: PERMISSIONS.DB_SYNC_JOBS_WRITE, label: 'Gerenciar jobs de sincronizacao', description: 'Criar, editar e remover jobs de sincronizacao de banco' },
  { key: PERMISSIONS.DB_SYNC_JOBS_RUN, label: 'Executar sincronizacao manual', description: 'Disparar sincronizacao imediatamente' },
  { key: PERMISSIONS.RESTORE_DRILL_JOBS_READ, label: 'Ver jobs de restore drill', description: 'Listar e visualizar jobs de validacao de restore' },
  { key: PERMISSIONS.RESTORE_DRILL_JOBS_WRITE, label: 'Gerenciar jobs de restore drill', description: 'Criar, editar e remover jobs de validacao de restore' },
  { key: PERMISSIONS.RESTORE_DRILL_JOBS_RUN, label: 'Executar restore drill manual', description: 'Disparar validacao de restore imediatamente' },
...
export const DEFAULT_ROLE_SEEDS: Array<{
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.DB_SYNC_JOBS_READ,
      PERMISSIONS.DB_SYNC_JOBS_RUN,
